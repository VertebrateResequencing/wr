...
EXTRA_FILES = [
    ...
    },
    {
        ...
        "manual_features": [
            ...
            ("WF-pipe", "pipe (|) operator for chaining processes/workflows"),
            ("WF-and", "and (&) operator for parallel process/workflow calls"),
            ("WF-recurse", ".recurse() method for process/workflow recursion"),
            ("WF-until", ".until() method — recursion termination condition"),
            ("WF-times", ".times() method — fixed-count recursion"),
            ...
            ("WF-out-index-header", "output block: index header sub-directive"),
            ("WF-out-index-path", "output block: index path sub-directive"),
            ("WF-out-index-sep", "output block: index sep sub-directive"),
