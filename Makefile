...
WEBUI_TEST_IMAGE_USER_SCREENSHOT ?= $(WEBUI_TEST_ARTIFACT_DIR)/status-webui-image-user-details.png
...
browser-test:
	...
	@PLAYWRIGHT_PACKAGE_DIR="$(WEBUI_TEST_PLAYWRIGHT_PACKAGE_DIR)" PLAYWRIGHT_BROWSERS_PATH="$(WEBUI_TEST_BROWSER_CACHE)" $(WEBUI_TEST_STEP_TIMEOUT) node jobqueue/testdata/image-user-details/screenshot.mjs "$(WEBUI_TEST_IMAGE_USER_SCREENSHOT)"
	...
	@echo "  $(WEBUI_TEST_IMAGE_USER_SCREENSHOT)"
