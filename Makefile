...
WEBUI_TEST_TWITCH_GAP_SCREENSHOT ?= $(WEBUI_TEST_ARTIFACT_DIR)/status-webui-snapshot-twitch-gap.png
WEBUI_TEST_TWITCH_RESTORED_SCREENSHOT ?= $(WEBUI_TEST_ARTIFACT_DIR)/status-webui-snapshot-twitch-restored.png
WEBUI_TEST_TWITCH_TRACE ?= $(WEBUI_TEST_ARTIFACT_DIR)/status-webui-snapshot-twitch-trace.json
...
WEBUI_TEST_FLICKER_OVERCOUNT_SCREENSHOT ?= $(WEBUI_TEST_ARTIFACT_DIR)/status-webui-repgroup-flicker-overcount.png
WEBUI_TEST_FLICKER_OVERCOUNT_TRACE ?= $(WEBUI_TEST_ARTIFACT_DIR)/status-webui-repgroup-flicker-overcount-trace.json
...
browser-test:
	...
	@PLAYWRIGHT_PACKAGE_DIR="$(WEBUI_TEST_PLAYWRIGHT_PACKAGE_DIR)" PLAYWRIGHT_BROWSERS_PATH="$(WEBUI_TEST_BROWSER_CACHE)" $(WEBUI_TEST_STEP_TIMEOUT) node jobqueue/testdata/status-page-snapshot-twitch/screenshot.mjs "$(WEBUI_TEST_TWITCH_GAP_SCREENSHOT)" "$(WEBUI_TEST_TWITCH_RESTORED_SCREENSHOT)" "$(WEBUI_TEST_TWITCH_TRACE)"
	...
	@PLAYWRIGHT_PACKAGE_DIR="$(WEBUI_TEST_PLAYWRIGHT_PACKAGE_DIR)" PLAYWRIGHT_BROWSERS_PATH="$(WEBUI_TEST_BROWSER_CACHE)" $(WEBUI_TEST_STEP_TIMEOUT) node jobqueue/testdata/repgroup-flicker-overcount/screenshot.mjs "$(WEBUI_TEST_FLICKER_OVERCOUNT_SCREENSHOT)" "$(WEBUI_TEST_FLICKER_OVERCOUNT_TRACE)"
	...
	@echo "  $(WEBUI_TEST_TWITCH_GAP_SCREENSHOT)"
	@echo "  $(WEBUI_TEST_TWITCH_RESTORED_SCREENSHOT)"
	@echo "  $(WEBUI_TEST_TWITCH_TRACE)"
	...
	@echo "  $(WEBUI_TEST_FLICKER_OVERCOUNT_SCREENSHOT)"
	@echo "  $(WEBUI_TEST_FLICKER_OVERCOUNT_TRACE)"
